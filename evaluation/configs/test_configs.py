...
class TestConfigs(unittest.TestCase):
    def test_configs(self):
        import os
        from utils.os_utils import get_dir, recursive_listdir
    ...
    def validate_config(self, filename):
        ...
        from evaluation.split_actions import ActionsSplitter
        ...
        self.assertTrue(isinstance(config.SPLIT_STRATEGY, ActionsSplitter),
                        f"Split strategy has wrong type: f{type(config.SPLIT_STRATEGY)}")
